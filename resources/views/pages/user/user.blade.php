             ...
             <div class="modal-content">
                 ...
                 <div class="modal-body">
                     ...
                     <form action="{{ route('userweb.store') }}" method="POST" enctype="multipart/form-data">
                         ...
                         {{-- Foto --}}
                         <div class="mb-3">
                             <label for="fileUpload" class="font-weight-bold">Unggah Berkas</label>
                             <div class="custom-file">
                                 <input type="file" class="custom-file-input" id="fileUpload" name="foto">
     ...
     <script>
         $(document).ready(function() {
             $('#modalEditUser').on('show.bs.modal', function(event) {
                 ...
                 $('#formEditUser').attr('action', '/user/' + id);
                 $('#edit_nama').val(nama);
