    ...
    <div class="container">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Data Operator Sinyal untuk pendataan RT</h6>
            </div>
            <div class="card-body">
                            ...
                            @foreach ($data as $j)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('operatorsinyal.destroy', $j->id) }}" method="POST"
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('operatorsinyal.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label>ID</label>
                        ...
                        <div class="mb-3">
                            <label>Jenis Operator Sinyal</label>
        ...
        <div class="modal fade" id="modalEditData{{ $j->id }}" tabindex="-1"
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="modal-body">
                            <form id="formEditData" action="{{ route('operatorsinyal.update', $j->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="mb-3">
                                    <label>ID</label>
                                ...
                                <div class="mb-3">
                                    <label>Jenis Operator Sinyal</label>
                                    <input type="text" value="{{ $j->nama_operator }}" name="nama_operator"
