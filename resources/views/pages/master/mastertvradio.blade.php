    ...
    <div class="container">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Data Program TV Radio untuk pendataan RT</h6>
            </div>
            <div class="card-body">
                            ...
                            @foreach ($data as $j)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('tvradio.destroy', $j->id) }}" method="POST"
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('tvradio.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label>ID</label>
                        ...
                        <div class="mb-3">
                            <label>Jenis Program TV Radio</label>
                            <input type="text" name="program_tv_radio" class="form-control" required>
                        </div>
        ...
        <div class="modal fade" id="modalEditData{{ $j->id }}" tabindex="-1"
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="modal-body">
                            <form id="formEditData" action="{{ route('tvradio.update', $j->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="mb-3">
                                    <label>ID</label>
                                ...
                                <div class="mb-3">
                                    <label>Jenis Program TV Radio</label>
                                    <input type="text" value="{{ $j->program_tv_radio }}" name="program_tv_radio"
