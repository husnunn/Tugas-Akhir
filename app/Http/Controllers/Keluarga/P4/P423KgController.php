...
use App\Models\Master\MasterNakesM;
...
class P423KgController extends Controller
{
    public function index()
    {
        ...
        $masternakes = MasterNakesM::all();

        return view('pages.keluarga.p4.kgp423', compact('data', 'datap2', 'masternakes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            KgP423M::create([
                'id' => "KGP423-" . strtotime(date("Y-m-d H:i:s")),
                'id_buat' => $userId,
            ...
            return redirect()->back()->with('success', 'Data keluarga P423 berhasil ditambahkan!');
        } catch (\Throwable $e) {
            DB::rollBack();
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->back()->with('success', 'Data keluarga P423 berhasil diperbarui');
    }

    public function destroy($id)
    {
        KgP423M::findOrFail($id)->delete();

        return redirect()->back()->with('success', 'Data keluarga P423 berhasil dihapus.');
    }
}
